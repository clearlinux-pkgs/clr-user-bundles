...
Version  : 2
Release  : 3
URL      : http://localhost/cgit/projects/clr-user-bundles/snapshot/clr-user-bundles-2.tar.gz
Source0  : http://localhost/cgit/projects/clr-user-bundles/snapshot/clr-user-bundles-2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1548548625
make  %{?_smp_mflags}
