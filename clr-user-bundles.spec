...
Source0  : https://github.com/clearlinux/clr-user-bundles/releases/download/v13.0.0/clr-user-bundles-v13.0.0.tar.xz
...
%prep
%setup -q -n clr-user-bundles-v13.0.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1561752481
