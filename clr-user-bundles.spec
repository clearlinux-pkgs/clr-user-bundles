...
Version  : 4
Release  : 5
URL      : http://localhost/cgit/projects/clr-user-bundles/snapshot/clr-user-bundles-4.tar.gz
Source0  : http://localhost/cgit/projects/clr-user-bundles/snapshot/clr-user-bundles-4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1548711685
make  %{?_smp_mflags}
