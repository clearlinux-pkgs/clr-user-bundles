...
Version  : 10
Release  : 9
URL      : http://localhost/cgit/projects/clr-user-bundles/snapshot/clr-user-bundles-10.tar.gz
Source0  : http://localhost/cgit/projects/clr-user-bundles/snapshot/clr-user-bundles-10.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1549409394
make  %{?_smp_mflags}
