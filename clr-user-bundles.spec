...
Version  : 3
Release  : 4
URL      : http://localhost/cgit/projects/clr-user-bundles/snapshot/clr-user-bundles-3.tar.gz
Source0  : http://localhost/cgit/projects/clr-user-bundles/snapshot/clr-user-bundles-3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1548692741
make  %{?_smp_mflags}
