...
Version  : 6
Release  : 6
URL      : http://localhost/cgit/projects/clr-user-bundles/snapshot/clr-user-bundles-6.tar.gz
Source0  : http://localhost/cgit/projects/clr-user-bundles/snapshot/clr-user-bundles-6.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1548891773
make  %{?_smp_mflags}
