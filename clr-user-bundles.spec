...
Version  : 8
Release  : 8
URL      : http://localhost/cgit/projects/clr-user-bundles/snapshot/clr-user-bundles-8.tar.gz
Source0  : http://localhost/cgit/projects/clr-user-bundles/snapshot/clr-user-bundles-8.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1548976673
make  %{?_smp_mflags}
